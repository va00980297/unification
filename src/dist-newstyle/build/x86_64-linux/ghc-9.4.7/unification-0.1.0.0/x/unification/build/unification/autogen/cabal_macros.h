...
/* package unification-0.1.0.0 */
#ifndef VERSION_unification
#define VERSION_unification "0.1.0.0"
#endif /* VERSION_unification */
#ifndef MIN_VERSION_unification
#define MIN_VERSION_unification(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_unification */
...
#define CURRENT_COMPONENT_ID "unification-0.1.0.0-inplace-unification"
